...
A project should have clear aims and a comprehensive specification that defines requirements before you begin coding. Without them, you will not be able to set a proportionate level of quality assurance and decide how much documentation you will need for the work. Deciding on your aims early on will keep your project focused on the end goal. The ONS [Quality Standard for Analysis](https://officenationalstatistics.sharepoint.com/sites/onswiki/SitePages/Quality_Standards.aspx) sets out standards and expectations around project specification and assurance. RAP pipelines will usually form part of a wider project that is underpinned by that standard.
